...
<% News post = (News) request.getAttribute("post");
    if(post!=null){%>
<!-- Page Wrapper -->
<div id="wrapper">
     <!-- Sidebar -->
                        ...
                        <div class="card-body">
                            <form action="/editNews" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-user" id="title" name="title" value="<%=post.getTitle()%>"
                                           required>
                                </div>
                                <div class="form-group">
                                    <label for="postContent" >Name</label>
                                    <textarea class="form-control form-control-user" id="postContent" name="content"
                                              required><%=post.getContent()%></textarea>
                                </div>
                                <div class="form-group">
                                    <select class="form-control"   id="role" name="categoryId" required>
